    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var user=_applicationDbContext.ApplicationUsers.FirstOrDefault(u=>u.Id == Input.Email);
                    int count=_applicationDbContext.ShoppingCarts.Where(u => u.ApplicationUser.Id == user.Id).Count();
